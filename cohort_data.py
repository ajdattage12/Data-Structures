...
def students_by_cohort(filename, cohort='All'):
    ...
    for line in cohort_data: 
        first_name, last_name, house, advisor, cohort_name = line.strip().split('|')
...
def get_housemates_for(filename, name):
    ...
    if target_person:
        target_name, target_house, target_adv, target_cohort = target_person

        for full_name, house, target_adv, cohort_name in all_data(filename):
